  ...
  return (
    <section className="relative py-32 overflow-hidden">
      ...
      <div className="relative z-10 container max-w-3xl text-center">
        <p className="font-body text-xs uppercase tracking-[0.3em] text-cream/70 mb-6">
          Agende Agora
        </p>
        <h2 className="font-display text-4xl md:text-5xl lg:text-6xl font-medium text-cream leading-tight mb-6">
          Pronta para se <span className="italic text-gradient-gold">transformar</span>?
        </h2>
        <p className="font-body text-lg text-cream/70 font-light mb-10 max-w-lg mx-auto">
