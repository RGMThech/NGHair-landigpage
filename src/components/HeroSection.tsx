    ...
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-6 text-center">
        ...
        <div className="animate-fade-up-delay-3 mt-10 flex flex-col sm:flex-row gap-4">
          ...
          <a
            href="#servicos"
            className="inline-flex items-center gap-2 rounded-full border border-cream/30 px-8 py-4 font-body text-sm font-medium text-cream uppercase tracking-wider transition-all duration-300 hover:bg-cream/10"
          >
            Nossos Serviços
          </a>
        </div>
